...
`,$=()=>o(T,{children:[e("img",{src:"/assets/profile_pic.jpg",alt:"Sou eu!"}),e("h2",{children:"Oi! Meu nome \xE9 Guilherme da Silva Sousa."}),e("p",{children:"Desenvolvedor Fullstack no Mais Esports, atualmente cursando faculdade de Engenharia de Software na Universidade Est\xE1cio de S\xE1."})]}),M=t.nav`
  display: flex;
  align-items: center;
...
`,q=()=>{const[r,i]=c.exports.useState(!0),s=c.exports.useRef(null),l=c.exports.useRef(null);function n(d){const[m]=d;i(m.isIntersecting)}function a(){window.scrollTo({top:0,behavior:"smooth"}),l.current&&l.current.classList.add("disabling")}return c.exports.useEffect(()=>{let d={root:null,rootMargin:"0px",threshold:1};const m=new IntersectionObserver(n,d);return s.current&&m.observe(s.current),()=>{s.current&&m.unobserve(s.current)}},[]),o(b,{children:[o(M,{ref:s,children:[e(p,{href:"#about-me",children:"Sobre mim"}),e(p,{href:"#experience",children:"Experi\xEAncia"}),e(p,{href:"#education",children:"Forma\xE7\xE3o Acad\xEAmica"}),e(p,{href:"#projects",children:"Projetos"})]}),!r&&o(G,{ref:l,onClick:a,children:["Retornar ao topo ",e(w,{size:28})]})]})},h=t.section`
  margin-top: 1em;
  font-size: 1.2em;
...
Uso de tecnologias como Express, Prisma, Next.JS e algumas APIs de terceiros.`}];const V=()=>o(h,{id:"experience",children:[e("h1",{children:"Experi\xEAncia"}),e(_,{children:H.map((r,i)=>o(W,{children:[e("img",{src:r.imageUrl,alt:r.company}),o(X,{children:[e(Y,{children:r.company}),e("div",{children:r.position}),o("div",{children:["Per\xEDodo: ",r.period]}),e("p",{children:r.description})]})]},`experience-${i}`))})]}),K=t.div`
  margin-top: 1em !important;
...
`,ne=t.div`
  color: #fff;
  font-size: 0.9em;
`;var ie=[{name:"Dramaland",imageUrl:"/assets/dramaland.png",description:`Um portal de not\xEDcias, resenhas e opini\xE3o do mundo da dramaturgia coreana. 
 ...
 Constru\xEDdo usando React, Firebase e Styled Components.`,url:"https://correioanonimo.com.br",year:"2021"}];const ae=()=>o(h,{id:"projects",children:[e("h1",{children:"Projetos"}),e(ee,{children:ie.map((r,i)=>o(re,{href:"https://correioanonimo.com.br",target:"_blank",rel:"noreferrer",children:[e(oe,{src:r.imageUrl,alt:r.name}),o(te,{children:[r.name," ",e(S,{})]}),e(ne,{children:r.year}),e("p",{children:r.description})]},`project-${i}`))})]}),se=()=>o(N,{children:[e($,{}),e(q,{}),e(J,{}),e(V,{}),e(Z,{}),e(ae,{})]}),f=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a","Enter"];var u=0;function x(r){const{key:i}=r;if(u==f.length-1){window.alert("Voc\xEA achou o easter egg!");return}i==f[u]?u++:u=0}function de(){return c.exports.useEffect(()=>(window.addEventListener("keydown",x),()=>window.removeEventListener("keydown",x)),[]),o(b,{children:[e(D,{}),e(z,{theme:L,children:e(R,{basename:"/",children:e(F,{children:e(j,{path:"/",element:e(se,{})})})})})]})}P.render(e(C.StrictMode,{children:e(de,{})}),document.getElementById("root"));
