import{r as d,W as y,s as n,j as x,g as E,I as C,H as $,Z as S,B as A,a as z,b as T,c as j,d as F,e as L,F as R,f as I,R as P,h as M,i as B,k as O}from"./vendor.8550df60.js";const N=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const m of l.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&i(m)}).observe(document,{childList:!0,subtree:!0});function s(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(a){if(a.ep)return;a.ep=!0;const l=s(a);fetch(a.href,l)}};N();const U="@guilherssousa:";function D(o,t){const s=U+o,[i,a]=d.exports.useState(()=>{const l=localStorage.getItem(s);return l!=null?JSON.parse(l):typeof t=="function"?t():t});return d.exports.useEffect(()=>{localStorage.setItem(s,JSON.stringify(i))},[s,i]),[i,a]}const G=y`
  * {
    padding: 0;
    margin: 0;
