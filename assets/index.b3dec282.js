...
`,h=n.a`
  ...
  padding: 0.5em;
  font-weight: bold;
`,e=b.exports.jsx,r=b.exports.jsxs,x=b.exports.Fragment,G=()=>{const[o,i]=m.exports.useState(!1),l=m.exports.useRef(null);async function a(){if(o){l.current&&l.current.classList.add("close"),await setTimeout(()=>i(!1),300);return}i(!0)}return r(x,{children:[o&&e(M,{children:r(X,{ref:l,children:[e(v,{onClick:a,children:e(A,{color:"#fff",size:45})}),e(h,{href:"#about-me",onClick:a,children:"Sobre mim"}),e(h,{href:"#experience",onClick:a,children:"Experi\xEAncia"}),e(h,{href:"#education",onClick:a,children:"Forma\xE7\xE3o Acad\xEAmica"}),e(h,{href:"#projects",onClick:a,children:"Projetos"})]})}),e(v,{onClick:a,children:e(C,{color:"#fff",size:45})})]})},q=n.div`
...
`;var he=[{name:"Dramaland",imageUrl:"/assets/dramaland.webp",description:`Um portal de not\xEDcias, resenhas e opini\xE3o do mundo da dramaturgia coreana. 
 ...
 Constru\xEDdo usando React, Firebase e Styled Components.`,url:"https://correioanonimo.com.br",year:"2021"}];const ge=()=>r(f,{id:"projects",children:[e("h1",{children:"Projetos"}),e(de,{children:he.map((o,i)=>r(ce,{href:"https://correioanonimo.com.br",target:"_blank",rel:"noreferrer",children:[e(me,{src:o.imageUrl,alt:o.name}),r(ue,{children:[o.name," ",e(j,{})]}),e(pe,{children:o.year}),e("p",{children:o.description})]},`project-${i}`))})]}),fe=()=>r(_,{children:[e(G,{}),e(Y,{}),e(Q,{}),e(Z,{}),e(ie,{}),e(le,{}),e(ge,{})]}),w=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a","Enter"];var u=0;function E(o){const{key:i}=o;if(u==w.length-1){window.alert("Voc\xEA achou o easter egg!"),u=0;return}i==w[u]?u++:u=0}function be(){return m.exports.useEffect(()=>(window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)),[]),r(x,{children:[e(N,{}),e(F,{theme:U,children:e(I,{basename:"/",children:e(P,{children:e(L,{path:"/",element:e(fe,{})})})})})]})}O.render(e(B.StrictMode,{children:e(be,{})}),document.getElementById("root"));
