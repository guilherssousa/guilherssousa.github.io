...
`;var he=[{name:"Dramaland",imageUrl:"/assets/dramaland.webp",description:`Um portal de not\xEDcias, resenhas e opini\xE3o do mundo da dramaturgia coreana. 
 ...
 Constru\xEDdo usando React, Firebase e Styled Components.`,url:"https://correioanonimo.com.br",year:"2021"}];const ge=()=>r(f,{id:"projects",children:[e("h1",{children:"Projetos"}),e(de,{children:he.map((o,i)=>r(ce,{href:"https://correioanonimo.com.br",target:"_blank",rel:"noreferrer",children:[e(me,{src:o.imageUrl,alt:o.name}),r(ue,{children:[o.name," ",e(j,{})]}),e(pe,{children:o.year}),e("p",{children:o.description})]},`project-${i}`))})]}),fe=()=>r(_,{children:[e(q,{}),e(Y,{}),e(Q,{}),e(Z,{}),e(ie,{}),e(le,{}),e(ge,{})]}),E=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a","Enter"];var u=0;function w(o){const{key:i}=o;if(u==E.length-1){window.alert("Voc\xEA achou o easter egg!"),u=0;return}i==E[u]?u++:u=0}function be(){return m.exports.useEffect(()=>(window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)),[]),r(x,{children:[e(D,{}),e(F,{theme:U,children:e(I,{basename:"/",children:e(L,{children:e(P,{path:"/",element:e(fe,{})})})})})]})}O.render(e(B.StrictMode,{children:e(be,{})}),document.getElementById("root"));
