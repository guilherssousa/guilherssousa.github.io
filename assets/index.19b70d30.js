import{r as d,W as y,s as n,j as x,g as E,I as C,H as $,Z as S,B as A,a as z,b as T,c as j,d as F,e as L,F as R,f as I,R as P,h as B,i as M,k as O}from"./vendor.8550df60.js";const N=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const m of l.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&i(m)}).observe(document,{childList:!0,subtree:!0});function s(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(a){if(a.ep)return;a.ep=!0;const l=s(a);fetch(a.href,l)}};N();const U="@guilherssousa:";function D(o,t){const s=U+o,[i,a]=d.exports.useState(()=>{const l=localStorage.getItem(s);return l!=null?JSON.parse(l):typeof t=="function"?t():t});return d.exports.useEffect(()=>{localStorage.setItem(s,JSON.stringify(i))},[s,i]),[i,a]}const G=y`
  * {
    padding: 0;
    margin: 0;
...
`,X={name:"dark",backgroundColor:"#1e293b",primary:"#f97316",secondary:"#fff",textColor:"#fff",backgroundGradient:"linear-gradient(83.2deg, rgba(33, 31, 88, 1) 10.8%, rgba(43, 54, 87, 1) 94.3%)",patternStrokeColor:"rgb(240 232 213 / 0.08)"},J={name:"light",backgroundColor:"#FEFEFE",primary:"#f97316",secondary:"#222",textColor:"#121212",patternStrokeColor:"rgb(15 23 42 / 0.04)"},q=n.div`
...
`,W=n.div`
  ...
  position: relative;
  z-index: 10;
`,e=x.exports.jsx,r=x.exports.jsxs,b=x.exports.Fragment,Y=({children:o})=>r(q,{children:[e(H,{}),e(W,{children:o})]}),c=E({small:"640px",medium:"768px",large:"1024px"}),_=n.section`
  display: flex;
...
`,ve=n.div`
  color: ${o=>o.theme.textColor} !important;
  font-size: 0.9em;
`;var we=[{name:"Dramaland",imageUrl:"/assets/dramaland.webp",description:`Um portal de not\xEDcias, resenhas e opini\xE3o do mundo da dramaturgia coreana. 
 ...
 Constru\xEDdo usando React, Firebase e Styled Components.`,url:"https://correioanonimo.com.br",year:"2021"},{name:"P44blo.",imageUrl:"/assets/p44blo.webp",description:`Ruan 'p44blo' \xE9 um editor de v\xEDdeos de Blumenau/SC. 

 Constru\xEDdo com HTML, CSS e Javascript Vanilla.`,url:"http://www.p44blo.com",year:"2020"}];const ke=()=>r(f,{id:"projects",children:[e("h1",{children:"Projetos"}),e(ge,{children:we.map((o,t)=>r(fe,{href:o.url,target:"_blank",rel:"noreferrer",children:[e(xe,{src:o.imageUrl,alt:o.name,loading:"lazy"}),r(be,{children:[o.name," ",e(L,{})]}),e(ve,{children:o.year}),e("p",{children:o.description})]},`project-${t}`))})]}),ye=({themeSwitcher:o})=>r(Y,{children:[e(oe,{themeSwitcher:o}),e(ne,{}),e(ie,{}),e(me,{}),e(he,{}),e(ke,{})]}),w=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a","Enter"];var u=0;function k(o){const{key:t}=o;if(u==w.length-1){window.alert("Voc\xEA achou o easter egg!"),u=0;return}t==w[u]?u++:u=0}function Ee(){const[o,t]=D("theme","dark");return d.exports.useEffect(()=>(window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)),[]),e(b,{children:r(R,{theme:o=="light"?J:X,children:[e(G,{}),e(I,{basename:"/",children:e(P,{children:e(B,{path:"/",element:e(ye,{themeSwitcher:t})})})})]})})}M.render(e(O.StrictMode,{children:e(Ee,{})}),document.getElementById("root"));
