...
`,J=n.div`
  ...
  position: relative;
  z-index: 10;
`,_=({children:o})=>r(G,{children:[e(H,{}),e(J,{children:o})]}),V=n.section`
  display: flex;
...
`,W=()=>r(V,{children:[e("img",{src:"/assets/profile_pic.webp",alt:"Sou eu!"}),e("h2",{children:"Oi! Meu nome \xE9 Guilherme da Silva Sousa."}),e("p",{children:"Desenvolvedor Fullstack no Mais Esports, atualmente cursando faculdade de Engenharia de Software na Universidade Est\xE1cio de S\xE1."})]}),Y=n.nav`
  display: flex;
  align-items: center;
...
`;var he=[{name:"Dramaland",imageUrl:"/assets/dramaland.webp",description:`Um portal de not\xEDcias, resenhas e opini\xE3o do mundo da dramaturgia coreana. 
 ...
 Constru\xEDdo com HTML, CSS e Javascript Vanilla.`,url:"http://www.p44blo.com",year:"2020"}];const ge=()=>r(f,{id:"projects",children:[e("h1",{children:"Projetos"}),e(de,{children:he.map((o,i)=>r(ce,{href:o.url,target:"_blank",rel:"noreferrer",children:[e(me,{src:o.imageUrl,alt:o.name,loading:"lazy"}),r(ue,{children:[o.name," ",e(F,{})]}),e(pe,{children:o.year}),e("p",{children:o.description})]},`project-${i}`))})]}),fe=()=>r(_,{children:[e(q,{}),e(W,{}),e(Q,{}),e(Z,{}),e(ie,{}),e(le,{}),e(ge,{})]}),w=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a","Enter"];var u=0;function E(o){const{key:i}=o;if(u==w.length-1){window.alert("Voc\xEA achou o easter egg!"),u=0;return}i==w[u]?u++:u=0}function be(){return m.exports.useEffect(()=>(window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)),[]),e(x,{children:r(j,{theme:U,children:[e(D,{}),e(I,{basename:"/",children:e(L,{children:e(P,{path:"/",element:e(fe,{})})})})]})})}B.render(e(O.StrictMode,{children:e(be,{})}),document.getElementById("root"));
